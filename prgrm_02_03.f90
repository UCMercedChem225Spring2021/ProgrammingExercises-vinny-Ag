		...
		integer::n1,n2
		real::M,L,K
		real::eigenvalue,eigenvalueModified,eigenvalueModTotal
		...
		eigenvalueModTotal = PIB_1D_MODIFIED_HAMILTONIAN_ELEMENT(M,L,n1,n2,K)
		
	999 format(1x,'Kinetic energy matrix element   ',I5,',',I5,' is ',F12.5,'.')
	998 format(1x,'Potential energy matrix element ',I5,',',I5,' is ',F12.5,'.')
	997 format(1x,'Hamiltonian matrix element      ',I5,',',I5,' is ',F12.5,'.')
		
		
		print 999,1,1,eigenvalue
		print 998,1,1,eigenvalueModified
		print 997,1,1,eigenvalueModTotal
		
		end program prgrm_02_03
		...
		! ********rotal modified matrix element for PIB below*******
		
		
		Real function PIB_1D_MODIFIED_HAMILTONIAN_ELEMENT(A,B,C,D,K)
		implicit none
		integer::C,D
		real::A,B,val03,K
		
		val03 = ((C**2)+(D**2))/(A*(B**2))+((K*B**2)/4)
		
		PIB_1D_MODIFIED_HAMILTONIAN_ELEMENT = val03
