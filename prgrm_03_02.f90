		...
		Print*,' '
		Print*,' '
		Print*,'Sanity check, your full Array w/ populated values:'
		Print*,Array_Input
		Print*,' '
		Print*,' '
		Print*,' '
		Print*,' '
		Print*,'Sanity check, your full Matrix populated values:'
		Do i = 1,NDim
			Matrix(1,i) = Array_Input(i)
			Matrix(2,i) = Array_Input(i+1)
			Matrix(3,i) = Array_Input(i+2)
			Matrix(4,i) = Array_Input(i+3)
		endDo
		...
		Print*,' '
		Print*,' '
		Print*,'Matrix values in dimensional form:'
		Do i = 1, NDim
			Print*, Matrix(1,i),Matrix(2,i),Matrix(3,i),Matrix(4,i)
		endDo
		...
		!
		Do i = 1,1
			AMatOut(i,1) = ArrayIn(i)
			AMatOut(i,2) = ArrayIn(i+1)
			AMatOut(i,3) = ArrayIn(i+2)
			AMatOut(i,4) = ArrayIn(i+3)
		endDo
		
		DO i = 2,2
			AMatOut(i,1) = ArrayIn(i)
			AMatOut(i,2) = ArrayIn(i+3)
			AMatOut(i,3) = ArrayIn(i+4)
			AMatOut(i,4) = ArrayIn(i+5)
		endDo
		
		DO i = 3,4
			AMatOut(i,1) = ArrayIn(i)
			AMatOut(i,2) = ArrayIn(i+3)
			AMatOut(i,3) = ArrayIn(i+5)
			AMatOut(i,4) = ArrayIn(i+6)
		endDo
		...
		Do i = 1,2
			AMatOut(i,1) = ArrayIn(i)
			AMatOut(i,2) = ArrayIn(i+1)
			AMatOut(i,3) = ArrayIn(i+3)
			AMatOut(i,4) = ArrayIn(i+6)
		endDo
		
		
		DO i = 3,3
			AMatOut(i,1) = ArrayIn(i+1)
			AMatOut(i,2) = ArrayIn(i+2)
			AMatOut(i,3) = ArrayIn(i+3)
			AMatOut(i,4) = ArrayIn(i+6)
		endDo
		
		DO i = 4,4
			AMatOut(i,1) = ArrayIn(i+3)
			AMatOut(i,2) = ArrayIn(i+4)
			AMatOut(i,3) = ArrayIn(i+5)
			AMatOut(i,4) = ArrayIn(i+6)
		endDo
		Print*,AMatOut
